      ...
      <section className="contactgrid section">
        <div className="contactcard">
          ...
          <div className="contactrows">
            ...
            <p>
              <Mail />
              <span>
                <b>Email</b>hello@kahwin-kahwin.club
              </span>
            </p>
            <p>
              <Clock />
        ...
        <div className="contactchoices">
          <a href="/ai-assistant">
            ...
            <div>
              <b>婚姻注册询问</b>
              <span>进入 AI Wedding Assistant</span>
            </div>
          </a>
          <a href="mailto:hello@kahwin-kahwin.club">
            <Store />
            <div>
              <b>商家合作</b>
              <span>申请加入合作伙伴网络</span>
            </div>
          </a>
        </div>
      </section>
