...
const zhToEn: Record<string, string> = {
  ...
  "婚姻注册、良辰吉日、婚礼服务，":
    "Marriage registration, auspicious dates and wedding services—",
  ...
  "您可以进入良辰吉日页面，按年份、月份与平日／周末偏好筛选。系统只使用管理员确认的日期资料。":
    "Visit the Auspicious Dates page and filter by year, month and weekday or weekend preference. The system only uses dates confirmed by the administrator.",
